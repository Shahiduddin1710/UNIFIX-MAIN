...
responseListener.current =
  ...
  } else if (data.type === "new_lost_found" || data.type === "item_handed_over" || data.type === "new_lost_report" || data.type === "lost_report_found") {
    const lfTab =
      data.type === "new_lost_found" ? "feed" :
      data.type === "item_handed_over" ? "claims" :
      data.type === "new_lost_report" ? "lostreports" :
      "lost-history";
    router.push({
      pathname: "/",
    ...
    return (
      <View style={styles.splash}>
        <Image
          ...
          resizeMode="contain"
        />
        <Text style={styles.splashTitle}>UniFiX</Text>
        <Text style={styles.splashSub}>VCET Campus Management</Text>
      </View>
    );
  }
